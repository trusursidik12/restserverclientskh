...
{
	// start datatables
    var $column_order = array(null, 'id_stasiun', 'waktu', 'h2s', 'cs2'); //set column field database for datatable orderable
    var $column_search = array('id_stasiun', 'waktu', 'h2s', 'cs2'); //set column field database for datatable searchable
